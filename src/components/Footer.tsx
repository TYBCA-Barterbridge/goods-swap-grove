    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">BarterBridge</h3>
            <p className="text-gray-400 mb-4">
              An innovative platform to exchange goods and skills without money,
              fostering a sustainable and collaborative economy.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/community/forum" className="text-gray-400 hover:text-white transition-colors">
                  Forum
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/community/resources" className="text-gray-400 hover:text-white transition-colors">
                  Resources
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} BarterBridge. All rights reserved.
          </p>
